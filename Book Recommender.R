...
#loading the files
books=read.csv("C:\\Users\\HP\\OneDrive\\Desktop\\Data Science\\study material\\PROJECT\\Book Recommender\\books.csv")
ratings=read.csv("C:\\Users\\HP\\OneDrive\\Desktop\\Data Science\\study material\\PROJECT\\Book Recommender\\ratings.csv")
books_tags=read.csv('C:\\Users\\HP\\OneDrive\\Desktop\\Data Science\\study material\\PROJECT\\Book Recommender\\book_tags.csv')
tags=read.csv("C:\\Users\\HP\\OneDrive\\Desktop\\Data Science\\study material\\PROJECT\\Book Recommender\\tags.csv")
...
#rmoving the users who rated more than 3 books

ratings%>%group_by(user_id)%>%mutate(Rating_Given=n())->ratings
ratings%>%filter(Rating_Given>2)->ratings

#selcting the sample from the dataset
set.seed(1)
user_fraction=0.02
...
#Finding the count of different geners

genres <- str_to_lower(c("Art", "Biography", "Business", "Chick Lit", "Children's", "Christian", 
                         "Classics", "Comics", "Cookbooks", "Crime", "Fantasy", "Gay and Lesbian", 
                         "Graphic Novels", "Historical Fiction", "History", "Horror", "Humor and Comedy",
                         "Manga", "Memoir", "Music", "Mystery", "Paranormal", "Philosophy", "Poetry", "Psychology",
